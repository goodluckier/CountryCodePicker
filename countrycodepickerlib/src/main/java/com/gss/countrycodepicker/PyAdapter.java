...
public abstract class PyAdapter<VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> implements View.OnClickListener {
    ...
    public void update(List<? extends PyEntity> entities, boolean isSearch){
        if(entities == null) throw new NullPointerException("entities == null!");
        entityList.clear();
        ...
        for (PyEntity entity : entities) {
            ...
            if(!TextUtils.isEmpty(pinyin)) {
                ...
                letterSet.add(new LetterEntity(letterStr));
            }
        }
        ...
        if(!isSearch){
            // 添加常用
            entityList.add(0,new Country(61, "澳大利亚"));
            entityList.add(0,new Country(1, "加拿大"));
            entityList.add(0,new Country(81, "日本"));
            entityList.add(0,new Country(1, "美国"));
            entityList.add(0,new Country(853, "中国澳门"));
            entityList.add(0,new Country(886, "中国台湾"));
            entityList.add(0,new Country(852, "中国香港"));
            entityList.add(0, new Country(86, "中国大陆"));
            entityList.add(0, new LetterEntity("常用"));
        }
